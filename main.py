...
def chat_bot():
    st.title("🤖Troy University Advisor is here")
...
def main_logic():
    ...
    st.set_page_config(page_title="Troy Advisor", page_icon="🤖")
    ...
    # Update st.session_state.api_key with the input value when provided
    if api_key_input:
    ...
    try:
        ...
        if 'conversational_rag_chain' not in st.session_state:
            ...
            llm = ChatOpenAI(api_key=st.session_state.api_key, model='gpt-4o')
